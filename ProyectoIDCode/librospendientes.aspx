<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="librospendientes.aspx.cs" Inherits="ProyectoIDCode.librospendientes" %>
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="widget-head-color-box navy-bg p-lg text-center">
                        ...
                        <asp:Image ID="Image2" runat="server"  class="img-circle circle-border m-b-md" alt="profile"  />
                        <%--<img src='<%#traer_imgalu() %>' class="img-circle circle-border m-b-md" alt="profile">--%>
                        <div>

...
namespace ProyectoIDCode.WSAlumnos {
    ...
    public partial class Alumno : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private string ds_celularField;
        
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private string ds_direccionField;
        
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private string ds_distritoField;
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private string ds_telefonoField;
        ...
        public string ds_celular {
            get {
                return this.ds_celularField;
            }
            set {
                if ((object.ReferenceEquals(this.ds_celularField, value) != true)) {
                    this.ds_celularField = value;
                    this.RaisePropertyChanged("ds_celular");
                }
            }
        }
        ...
        public string ds_direccion {
            get {
                return this.ds_direccionField;
            }
            set {
                if ((object.ReferenceEquals(this.ds_direccionField, value) != true)) {
                    this.ds_direccionField = value;
                    this.RaisePropertyChanged("ds_direccion");
                }
            }
        }
        ...
        public string ds_distrito {
            get {
                return this.ds_distritoField;
            }
            set {
                if ((object.ReferenceEquals(this.ds_distritoField, value) != true)) {
                    this.ds_distritoField = value;
                    this.RaisePropertyChanged("ds_distrito");
                }
            }
        }
        ...
        public string ds_telefono {
            get {
                return this.ds_telefonoField;
            }
            set {
                if ((object.ReferenceEquals(this.ds_telefonoField, value) != true)) {
                    this.ds_telefonoField = value;
                    this.RaisePropertyChanged("ds_telefono");
                }
            }
        }
    ...
    public interface IAlumnosService {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IAlumnosService/actualizarAlumno", ReplyAction="http://tempuri.org/IAlumnosService/actualizarAlumnoResponse")]
        ProyectoIDCode.WSAlumnos.Alumno actualizarAlumno(ProyectoIDCode.WSAlumnos.Alumno alu);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IAlumnosService/actualizarAlumno", ReplyAction="http://tempuri.org/IAlumnosService/actualizarAlumnoResponse")]
        System.Threading.Tasks.Task<ProyectoIDCode.WSAlumnos.Alumno> actualizarAlumnoAsync(ProyectoIDCode.WSAlumnos.Alumno alu);
    }
    ...
    public partial class AlumnosServiceClient : System.ServiceModel.ClientBase<ProyectoIDCode.WSAlumnos.IAlumnosService>, ProyectoIDCode.WSAlumnos.IAlumnosService {
        ...
        public ProyectoIDCode.WSAlumnos.Alumno actualizarAlumno(ProyectoIDCode.WSAlumnos.Alumno alu) {
            return base.Channel.actualizarAlumno(alu);
        }
        
        public System.Threading.Tasks.Task<ProyectoIDCode.WSAlumnos.Alumno> actualizarAlumnoAsync(ProyectoIDCode.WSAlumnos.Alumno alu) {
            return base.Channel.actualizarAlumnoAsync(alu);
        }
    }
}
